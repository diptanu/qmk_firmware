...
[_LOWER] = LAYOUT( \
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______, _______,  KC_HOME, KC_PGDN, KC_PGUP, KC_PGDN, KC_END, XXXXXXX, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                    KC_MINS, KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV, \
